...
RENDER_PATH = "/Users/dwilches/Desktop/"
MODELS_PATH = "/Users/dwilches/Dropbox/Uniandes/Doctorado/blender-python/"
SCORE_XML_FILENAME = "/Users/dwilches/DWilches/Code/ImageProcessing/Execution/score.xml"
...
for actor in actors.keys():
    ...
    elif actor.startswith("desert"):
        #bpy.ops.import_scene.autodesk_3ds(filepath=MODELS_PATH + "desertTruck.3ds")
    ...
    elif actor.startswith("ninja"):
        #bpy.ops.import_scene.autodesk_3ds(filepath=MODELS_PATH + "ninja.3ds")
        #bpy.context.scene.objects.active = bpy.data.objects['Bandersha']
...
# recorremos score
# for xmlScore in score.getElementsByTagName('score'):
# 	for xmlSound in xmlScore.getElementsByTagName('sound'):
# 		soundFile = xmlSound.getAttribute('value')
# 		for xmlFrame in xmlSound.getElementsByTagName('frame'):
# 			# agregamos strip de sonido
# 			# TODO: hacerlo para audio 3d
# 			bpy.ops.sequencer.sound_strip_add(filepath=soundFile, frame_start=int(xmlFrame.getAttribute('number')), channel=2)
...
if RENDER_VIDEO:
    ...
    bpy.context.scene.render.filepath = RENDER_PATH + "video "
    bpy.ops.render.render(animation=True)
else:
    bpy.context.scene.render.image_settings.file_format='PNG'
    bpy.context.scene.render.filepath = RENDER_PATH + "imagen"
