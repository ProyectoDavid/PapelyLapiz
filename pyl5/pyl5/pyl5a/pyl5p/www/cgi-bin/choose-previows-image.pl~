	...
	<head>
		...
		<script type='text/javascript' src='scripts/demo.js'></script>
		 ...
		 <script type='text/javascript'>
			function nl2br(str){
				str = str.substring(0, str.lastIndexOf('\.',0) + 2 );
				return str;
			}
		</script>
		...
		<script type='text/javascript'>
			function refreshParent(filename,dirname) {
				window.opener.document.location = 'cgi-bin/inicio.pl?lang=$lang&uploaddir='+dirname+'&imagename=Processing_'+filename;
				window.close();
			}
		...
		<div id='contenedor'>
			<div id='logo'>
				<div class='page_title'>
					<h2 class='logo'>@langPreloadedTitle</h2>
				</div>
			</div>
		</div>
...
while (readdir(IMAGE_DIR))
{
	...
	print "	<TD align='center'><B>$filename</B><BR/>" .
			...
			"<table height='250'>" .
				"<tr>" .
					"<td height='80%'><IMG SRC='output/images/$dirname/Processing_$filename' WIDTH='200'></td>" .
				"</tr>" .
				"<tr>" .
					"<td height='20%' align='center' style='vertical-align:text-bottom;'><A onClick=\"refreshParent('$filename','$dirname')\" href='#' >@langPreloadedExecute</A></td>" .
				"</tr>" .
				"<tr>" .
					"<td height='20%' align='center' style='vertical-align:text-bottom;'><A onClick=\"resendMail('$dirname')\" href=\"JavaScript:window.close()\" >@langPreloadedSendMail</A></td>" .
				"</tr>" .
			"</table>" .
		"</TD>\n";
