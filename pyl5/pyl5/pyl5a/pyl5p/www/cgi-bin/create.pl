...
<html xmlns='http://www.w3.org/1999/xhtml' xml:lang='es-es' lang='es-es' dir='ltr'>
	...
	<body style='font-size: 100%; '>
		<div id='contenedor'>
			<div id='logo'>
				<div class='page_title'>
					<h2 class='logo'>@langCreateTitle</h2>
				</div>
			</div>
		</div>
		<div id='contenedor' style='text-align:center;padding-left:20px;padding-right:20px;'>
			@langCreateIntro
			@langCreateText1
			<IMG src='images/@langCreateImg1' width='340px'/><br><br>
			@langCreateText2
			<IMG src='images/@langCreateImg2' width='340px'/><br><br>
			@langCreateText3
			<IMG src='images/@langCreateImg3' width='340px'/><br><br>
			@langCreateText4
			<IMG src='images/@langCreateImg4' width='340px'/><br><br>
			@langCreateText5
			<IMG src='images/@langCreateImg5' width='340px'/><br><br>
			@langCreateText6
			<IMG src='images/@langCreateImg6' width='400px'/><br><br>
			@langCreateText7
			<IMG src='images/@langCreateImg7' width='400px'/><br><br>
			@langCreateText8
			<IMG src='images/@langCreateImg8' width='340px'/><br><br>
			@langCreateText9
			<IMG src='images/@langCreateImg9' width='340px'/><br><br>
		</div>
